  ...
  return (
    <section className="confianza">
      <div className="contenedor">
        ...
        <div className="confianza__cards">
          <div className="confianza__cards--atencion">
            <div className="chat">
              <div className="chat__chat1">
                <img src={avatarHombre} alt="Imagen Cliente" />
              </div>

              <div className="burbuja">
                <div className="chat1">
                  <div className="simulacion__texto"></div>
                  <div className="simulacion__texto"></div>
                  <div className="simulacion__texto"></div>
                  <div className="simulacion__texto"></div>
                  <div className="simulacion__texto"></div>
          ...
          <div className="confianza__cards--tipos">
          ...
          <div className="confianza__cards--icono">
            <svg
              width="243"
              height="220"
              viewBox="0 0 243 220"
